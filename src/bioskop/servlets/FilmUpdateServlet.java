...
public class FilmUpdateServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		 try {
			 ...
			 }catch (Exception e) {throw new Exception("godina mora bit int");}
			 ...
			 Film film = new Film(intID, naziv, reziser, glumci, zanrovi, intTrajanje, distributer, zemljaPorekla, intGodina, opis);
			 System.out.println("=================================================");
